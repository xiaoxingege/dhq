...
<div class="dime-kline">
  <div>
    <div class="kline-title" v-if='(statusType==11 || statusType==12 || statusType==13 || statusType==20)'>{{dataIndex===0?'机构预测营业收入':'机构预测净收益'}}</div>
...
export default ({
  props: ['baseFace', 'dataIndex', 'innerCode', 'statusType'],
  data() {
    return {
      showX: true,
      legendNames: {},
