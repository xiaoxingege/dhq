        ...
        <div class="signal-table-wrap" slot="content">
          <table class="recentin-table">
            <tr v-for="(item,index) of recentInList">
              ...
              <td style="text-align: center;"><span style="display:inline-block;width:80px;height:20px;line-height:20px;background-color:#1984ea;color:#fff;">{{item.statusDisp}}</span></td>
            </tr>
          </table>
        </div>
