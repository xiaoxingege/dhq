...
<div class="map map_pad">
  ...
  :conditionTopic="conditionTopic" :conditionStock='conditionStock' 
  :topicIndexs='topicIndexs' :topicStockIndexs='topicStockIndexs' 
  @isStopPlayback="isShowMaskFn" @toZdfCondition="toZdf" @passMapType="getMapType"
    @passConditionStock="getConditionStock" @passConditionTopic="getConditionTopic" 
    @changeCondition="getChangeCondition" :conditionList="topicConditionList"></ThemeMap>
