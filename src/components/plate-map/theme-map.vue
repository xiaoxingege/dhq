...
<div class="map_wrap">
  ...
  <LeadStock :rangeCode="rangeCode" :condition="conditionTopic" :boxHeight="mapHeight" :conditionList="conditionList" :kLineType="kLineType" :isUnit="isUnit" v-if="isShowLeadStock && mapType === 'plate'"></LeadStock>
