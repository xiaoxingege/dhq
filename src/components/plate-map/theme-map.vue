  ...
  data() {
    return {
      ...
      colors: {
        ...
        'chg_pct.rising_speed':colorsList1.slice().reverse(),
        ...
        'chg_pct.rising_speed': colorsList1.slice().reverse(), // 三分钟涨速 绿-红
      ...
      rangeValues: {
        ...
        'chg_pct.rising_speed':this.fmtraneValue(valueRange1d,0.125), // 三分钟涨速
