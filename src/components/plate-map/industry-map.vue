...
export default {
  ...
  data() {
    return {
      ...
      colors: {
        /* 板块 */
        'indu_market.tech_index': colorsListRD.slice().reverse(), // 热度指数 灰-红
  ...
  methods: {
    ...
    startPlay: function() {
      ...
      if (this.playBackState) { // 播放中点击暂停
        ...
        if (this.conditionIndustry !== '') {
          this.conditionIndustry = ''
          this.$emit('toZdfCondition', this.conditionIndustry)
        }
