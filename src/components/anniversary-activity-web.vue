...
.bg1 {
    background: url("../assets/images/anniversary-activity/anniversary-web-b1.jpg") center 0 no-repeat;
    height: 550px;
}
.bg2 {
...
.bg3 {
    background: url("../assets/images/anniversary-activity/anniversary-web-b3.jpg") center 0 no-repeat;
    height: 1004px;
}
.bg4 {
