...
<div class="payment-success" :style="{height:containerHeight+'px'}">
  <div class="top">
    <div class="top-content">
      <img class="hint-img" src="../assets/images/payment/order-success.png" alt="">
      <div class="hint-text">
        <h3>订单支付成功</h3>
...
export default {
  ...
  methods: {
    ...
    getPaymentResult(){
      // http://cashier.jrj.com.cn/order/resultquery?version=1.0&signType=2&timeStamp=20180306144934&sign=abc&bizCode=5&sellerOrderId=13072357130764862668861200000552
      var url='http://cashier.jrj.com.cn/order/resultquery?version=1.0&signType=2&timeStamp=20180306144934&sign=abc&bizCode=5&sellerOrderId=13072357130764862668861200000552'
