...
.part1 {
  width: 100%;
  height: 6.31rem;
  background: url('../assets/images/video-program/part_01.jpg') center 0 no-repeat;
...
.part2 {
  width: 100%;
  height: 5.32rem;
  background: url('../assets/images/video-program/part_02.jpg') center 0 no-repeat;
  background-size: 100% 100%;
}
...
.part3 {
  width: 100%;
  height: 8.3rem;
  background: url('../assets/images/video-program/part_03.jpg') center 0 no-repeat;
  background-size: 100% 100%;
  position: relative;
}
...
.part3>div {
  width: 7.17rem;
  height: 8.3rem;
  background: url('../assets/images/video-program/main-app.png') center 0 no-repeat;
  background-size: 100% 100%;
  margin: 0 auto;
  overflow: hidden;
}
...
.part4 {
  width: 100%;
  height: 10.72rem;
  background: url('../assets/images/video-program/part_04.jpg') center 0 no-repeat;
  background-size: 100% 100%;
}
...
.part4 li:first-child {
  width: 2.64rem;
  height: 3.8rem;
  background: url('../assets/images/video-program/teacherApp.png') center 0 no-repeat;
  background-size: 100% 100%;
  margin-left: 1.7rem;
  overflow: hidden;
}

.part4 li:first-child+li {
  width: 2.16rem;
  height: 3.8rem;
  padding: .47rem .36rem 0 .36rem;
  box-sizing: border-box;
}

.part4 li:first-child+li p {
  width: 1.44rem;
  height: 0.5rem;
  background: #aa0108;
...
.part5 {
  width: 100%;
  height: 7.9rem;
  background: url('../assets/images/video-program/part_05.jpg') center 0 no-repeat;
  background-size: 100% 100%;
}
...
.part5>div {
  width: 7.3rem;
  height: 7rem;
  background: url('../assets/images/video-program/recordApp.png') center 0 no-repeat;
  background-size: 100% 100%;
  margin: 0 auto;
  font-size: 0.22rem;
  position: relative;
...
.part6 {
  width: 100%;
  height: 3.9rem;
  background: url('../assets/images/video-program/part_06.jpg') center 0 no-repeat;
  background-size: 100% 100%;
  position: relative;
}
...
.part6>ul {
  width: 7.14rem;
  margin: 0 auto;
  background: url('../assets/images/video-program/teamApp.png') center 0 no-repeat;
  background-size: 100% 100%;
  height: 3rem;
}
...
.tit {
  width: 5.45rem;
  height: 0.97rem;
  background: url('../assets/images/video-program/titApp.png') center 0 no-repeat;
  background-size: 100% 100%;
  position: absolute;
  left: 50%;
  top: -0.67rem;
  ...
  <div class="part5">
    <div>
      ...
      <p class="dec">金融界智能金融、投资顾问、研究院三大团队应用最前沿的智能金融技术，鼎力打造智能量化选股 利器——极智选股，三大核心服务精选好股，帮助大家解决选股难题。
        <i class="more"><a :href="data.stockMore">查看更多</a></i></p>
    </div>
  </div>
  <div class="part6">
