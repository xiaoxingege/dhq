...
.fall {
  color: #2DC678 !important;
}

.up {
  color: #F24637 !important;
}
...
.banner div:first-child {
  height: 530px;
  display: block;
  background: url('http://i0.jrjimg.cn/zqt-red-1000/focus/focus2017YMZ/Billboard/img/banner_01.jpg') center 0 no-repeat;
}

.banner div:first-child+div {
  height: 469px;
  display: block;
  background: url('http://i0.jrjimg.cn/zqt-red-1000/focus/focus2017YMZ/Billboard/img/banner_02.jpg') center 0 no-repeat;
}

.part01 {
  width: 100%;
  height: 487px;
  background: url('http://i0.jrjimg.cn/zqt-red-1000/focus/focus2017YMZ/Billboard/img/part01_bg.jpg') no-repeat;
...
.tit01Content>ul>li {
  width: 100%;
  height: 91px;
  background: url('http://i0.jrjimg.cn/zqt-red-1000/focus/focus2017YMZ/Billboard/img/partBtn.png') no-repeat;
  background-size: 100% 100%;
  overflow: hidden;
}

.tit01Content>ul>li p {
  width: 100%;
  font-size: 28px;
  line-height: 28px;
  margin-top: 13px;
...
.part02 {
  width: 100%;
  height: 504px;
  background: url('http://i0.jrjimg.cn/zqt-red-1000/focus/focus2017YMZ/Billboard/img/part02_bg.jpg') no-repeat;
  background-size: 100% 100%;
}
...
.part03 {
  width: 100%;
  height: 750px;
  background: url('http://i0.jrjimg.cn/zqt-red-1000/focus/focus2017YMZ/Billboard/img/part03_bg.jpg') no-repeat;
  background-size: 100% 100%;
}
...
.part04 {
  width: 100%;
  height: 415px;
  background: url('http://i0.jrjimg.cn/zqt-red-1000/focus/focus2017YMZ/Billboard/img/part04_bg.jpg') no-repeat;
  background-size: 100% 100%;
}
...
.part05 {
  width: 100%;
  height: 414px;
  background: url('http://i0.jrjimg.cn/zqt-red-1000/focus/focus2017YMZ/Billboard/img/part05_bg.jpg') no-repeat;
  background-size: 100% 100%;
}
...
.part05 ul li:first-child {
  width: 50%;
  height: 100%;
  background: url('http://i0.jrjimg.cn/zqt-red-1000/focus/focus2017YMZ/Billboard/img/part05_content01.jpg') no-repeat;
  background-size: 100% 100%;
}

.part05 ul li:first-child img {
  width: 441px;
  height: 236px;
  display: block;
  margin-top: 139px;
...
.part05 ul li:first-child+li {
  width: 50%;
  height: 100%;
  background: url('http://i0.jrjimg.cn/zqt-red-1000/focus/focus2017YMZ/Billboard/img/part05_content02.jpg') no-repeat;
  background-size: 100% 100%;
}

.part05 ul li:first-child+li img {
  width: 441px;
  height: 236px;
  display: block;
  margin-top: 139px;
...
.part06 .part61 {
  ...
  height: 423px;
  display: block;
  background: url('http://i0.jrjimg.cn/zqt-red-1000/focus/focus2017YMZ/Billboard/img/part06_img.jpg') center 0 no-repeat;
}
...
.part06>div {
  width: 100%;
  height: 234px;
  background: url('http://i0.jrjimg.cn/zqt-red-1000/focus/focus2017YMZ/Billboard/img/part06_bg.jpg') no-repeat;
  background-size: 100% 100%;
}
...
.bottomFix {
  width: 100%;
  height: 161px;
  background: url('http://i0.jrjimg.cn/zqt-red-1000/focus/focus2017YMZ/Billboard/img/appointmentBtn.jpg') center 0 no-repeat;
  position: fixed;
  bottom: 0;
  left: 0;
  z-index: 4;
...
.bottomFix ul li:first-child {
  margin-left: 65px;
}

.bottomFix ul li:first-child+li {
  margin-left: 13px;
}
...
.appointmentBtn {
  width: 223px;
  height: 76px;
  background: url(http://i0.jrjimg.cn/zqt-red-1000/focus/focus2017YMZ/Billboard/img/appointmentBtn.png) no-repeat;
  background-size: 100% 100%;
  position: absolute;
  top: -20px;
  right: 62px;
...
.item-qq {
  background: url(http://i0.jrjimg.cn/zqt-red-1000/focus/focus2017YMZ/Billboard/img/qq.jpg) top center;
}

.item-code {
  background: url(http://i0.jrjimg.cn/zqt-red-1000/focus/focus2017YMZ/Billboard/img/erCode.jpg) top center;
}

.item-top {
  background: url(http://i0.jrjimg.cn/zqt-red-1000/focus/focus2017YMZ/Billboard/img/top.jpg) top center;
}

.code {
  width: 205px;
  height: 226px;
  background: url('http://i0.jrjimg.cn/zqt-red-1000/focus/focus2017YMZ/Billboard/img/code.png') no-repeat;
  background-size: 100% 100%;
  position: absolute;
  top: 63px;
  right: 75px;
...
.tan {
  width: 643px;
  height: 445px;
  background: url('http://i0.jrjimg.cn/zqt-red-1000/focus/focus2017YMZ/Billboard/img/tanBg.png')no-repeat;
  background-size: 100% 100%;
  z-index: 7;
  margin-left: auto;
  margin-right: auto;
...
.tanCus {
  width: 704px;
  height: 296px;
  background: url('http://i0.jrjimg.cn/zqt-red-1000/focus/focus2017YMZ/Billboard/img/tanCus.png')no-repeat;
  background-size: 100% 100%;
  z-index: 7;
  margin-left: auto;
  margin-right: auto;
...
.closeImg {
  width: 46px;
  height: 46px;
  background: url('http://i0.jrjimg.cn/zqt-red-1000/focus/focus2017YMZ/Billboard/img/close.png')no-repeat;
  background-size: 100% 100%;
  position: absolute;
  top: -46px;
  right: -46px;
