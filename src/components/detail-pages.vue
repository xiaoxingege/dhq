...
<div class="news">
  <div v-if="this.type === 'news'" class="newsDiv">
    ...
    <div class="newDetail">
      ...
      <span v-if="result !== null && result.equityNews!== null && result.equityNews.length!==0" class="ml-15">相关股票：<span
              v-for="item in result.equityNews"
              class="mr-10">{{item.name}} [{{item.innerCode.substring(0,item.innerCode.indexOf('.'))}}]</span></span>
      <span v-if="result !== null && result.equityNews!== null && result.topicNews.length!==0" class="ml-15">相关题材：<span
              class="mr-15"
    ...
    <ul class="moreNewsList" v-for="item in this.moreInfor" v-if="result !== null && result.equityNews !== null &&  result.equityNews.length !== 0">
  ...
  methods: {
    getDetailPages() {
      ...
      this.$store.dispatch('zhikuanDetailPages/getDetailPages', {
        ...
        if (this.result !== null && this.result.topicNews !== null && this.result.topicNews.length === 0) {
        ...
        } else if (this.result !== null && this.result.equityNews !== null && this.result.equityNews.length === 0) {
