  ...
  data() {
    return {
      ...
      colors: {
        ...
        'act_date': colorsList1.slice().reverse(), // 业绩公布日
        'mkt_idx.keep_days_today': colorsList1.slice().reverse(), // 连涨天数
        'margin_buy_value': colorsListRZMR.slice().reverse(), // 融资买入额
        'margin_buy_net_value': colorsList1.slice().reverse() // 融资净买入额
      },
      rangeValues: {
        ...
        'act_date': this.fmtraneValue(valueRange1d, 8), // 业绩公布日
        'mkt_idx.keep_days_today': valueRangeUD,
        'margin_buy_value': valueRangeRZMR,
        'margin_buy_net_value': valueRangeRZJMR
      },
      isUnit: {
