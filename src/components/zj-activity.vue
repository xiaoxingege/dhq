...
<div class="box">
    ...
    <div class="footer">
        <div class="box-con">
            <div id="divdown1">
                <span id="text-day" class="text-day">00</span><em>天</em><span id="text-hour" class="text-hour">00</span><em>小时</em><span id="text-min" class="text-min" style="display:none;">00</span><em style="display:none;">分</em><span id="text-sec"
                    class="text-sec" style="display:none;">00</span><em style="display:none;">秒</em>
            </div>
        </div>
    </div>
    <div class="nav-fixed">
