<style>
   ...
   .recipient-content p,.sender-content p{
       padding: 21px 25px;
       border-radius:20px;
   ...
   .recipient-headimage img,.sender-headimage img{
       width: 42px;
       height: 43px;
       border-radius: 50%;
   }
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            pullMessage(){
                this.$store.dispatch('touguSpaceConsultation/getSpaceConsultation',{ maxId:this.maxId,adviserId:this.studioList.userid }).then(() => {
