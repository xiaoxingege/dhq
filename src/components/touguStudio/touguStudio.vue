        ...
        <div class="item item4">
          <div class="item4-bh">
             ...
             <div class="itemBh-three">
                 <div class="fStudio" id="160603010046392493" @click="checkJurisdiction($event)">
            ...
            $(function() {
                ...
                $(window).scroll(function() {
                    if ($(window).scrollTop() >= 400 && $(window).scrollTop() <= 1202) {
                        ...
                        $('#HX').css({
                            'color': 'rgba(230,220,207,1)',
                            'background': '-webkit-linear-gradient(top,#665B4A,#2D2922)'
                        });
                        $('#FW').css({
...
<style>
    ...
    .button-click {
        width: 120px;
        height: 38px;
        background: -webkit-linear-gradient( top, #D69A39, #B17E2C);
        border-radius: 19px;
