...
.tougu-workspace-header {
    height: 108px;
    background: url('../../assets/images/touguStudio/tougu-workspace-header-bg.png') center no-repeat;
    background-size: cover;
}
.studio-info-headimage {
    width: 73px;
    height: 72px;
    margin-left: 36px;
    margin-top: 22px;
