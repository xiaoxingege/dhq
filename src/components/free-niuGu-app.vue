...
.item1 {
  width: 100%;
  height: 7.8rem;
  background: url('../assets/images/free-niuGu-app/item_01.jpg') center 0 no-repeat;
...
.item1 a {
  width: 1.99rem;
  height: 2.03rem;
  background: url('../assets/images/free-niuGu-app/re-btn.png') center 0 no-repeat;
  background-size: 100% 100%;
  position: absolute;
  top: 4.39rem;
  right: 50%;
...
.item2 {
  width: 100%;
  height: 3.36rem;
  background: url('../assets/images/free-niuGu-app/item_02.jpg') center 0 no-repeat;
  background-size: 100% 100%;
}
...
.item3 {
  width: 100%;
  height: 4.24rem;
  background: url('../assets/images/free-niuGu-app/item_03.jpg') center 0 no-repeat;
  background-size: 100% 100%;
  overflow: hidden;
}
...
.item3 ul {
  width: 6.64rem;
  height: 4rem;
  background: url('../assets/images/free-niuGu-app/phone-bg.png') center 0 no-repeat;
  background-size: 100% 100%;
  margin: 0 auto;
  margin-top: 0.2rem;
  overflow: hidden;
...
.tan li:first-child i {
  width: 0.23rem;
  height: 0.28rem;
  background: url('../assets/images/free-niuGu-app/p-icon.png') center 0 no-repeat;
  background-size: 100% 100%;
  display: block;
  float: left;
  position: absolute;
...
.tan li:first-child+li i {
  width: 0.22rem;
  height: 0.27rem;
  background: url('../assets/images/free-niuGu-app/t-icon.png') center 0 no-repeat;
  background-size: 100% 100%;
  display: block;
  float: left;
  position: absolute;
...
.item4 {
  width: 100%;
  height: 7.6rem;
  background: url('../assets/images/free-niuGu-app/item_04.jpg') center 0 no-repeat;
  background-size: 100% 100%;
}
...
.item5 {
  width: 100%;
  height: 6.57rem;
  background: url('../assets/images/free-niuGu-app/item_05.jpg') center 0 no-repeat;
  background-size: 100% 100%;
}
...
.item6 ul {
  width: 6.64rem;
  height: 3.97rem;
  background: url('../assets/images/free-niuGu-app/phone-bg2.png') center 0 no-repeat;
  background-size: 100% 100%;
  margin: 0 auto;
  overflow: hidden;
  padding-top: 1.4rem
...
.item7 {
  width: 100%;
  height: 3.7rem;
  background: url('../assets/images/free-niuGu-app/item_07.jpg') center 0 no-repeat;
  background-size: 100% 100%;
}
...
.bom-btn {
  width: 100%;
  height: 1.2rem;
  background: url('../assets/images/free-niuGu-app/bom-btn.png') center 0 no-repeat;
  background-size: 100% 100%;
  position: fixed;
  bottom: 0;
  left: 0;
...
.fix-btn {
  width: 1.19rem;
  height: 1.19rem;
  background: url('../assets/images/free-niuGu-app/fix-btn.png') center 0 no-repeat;
  background-size: 100% 100%;
  position: fixed;
  top: 4.38rem;
  right: 0;
...
.Alert-phone {
  width: 100%;
  height: 6.47rem;
  background: url('../assets/images/free-niuGu-app/alertPhone.png') center 0 no-repeat;
  background-size: 100% 100%;
  position: fixed;
  top: 10%;
  left: 0;
...
.alert-input {
  width: 6.64rem;
  height: 3.75rem;
  background: url('../assets/images/free-niuGu-app/alert-input.png') center 0 no-repeat;
  background-size: 100% 100%;
  position: fixed;
  top: 10%;
  left: 50%;
