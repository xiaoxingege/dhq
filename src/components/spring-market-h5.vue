...
.item1 {
  width: 100%;
  height: 5.2rem;
  background: url('../assets/images/spring-market/item_01.png') no-repeat center 0;
...
.item2 {
  width: 100%;
  height: 4.18rem;
  background: url('../assets/images/spring-market/item_02.png') no-repeat center 0;
  background-size: 100% 100%;
}
...
.item3 {
  width: 100%;
  height: 4.5rem;
  background: url('../assets/images/spring-market/item_03.png') no-repeat center 0;
  background-size: 100% 100%;
}
...
.item4 {
  width: 100%;
  height: 8.1rem;
  background: url('../assets/images/spring-market/item_04.png') no-repeat center 0;
  background-size: 100% 100%;
}
...
.item5 {
  width: 100%;
  height: 2.85rem;
  background: url('../assets/images/spring-market/item_05.png') no-repeat center 0;
  background-size: 100% 100%;
  overflow: hidden;
}
...
.item6 {
  width: 100%;
  height: 2.85rem;
  background: url('../assets/images/spring-market/item_06.png') no-repeat center 0;
  background-size: 100% 100%;
  overflow: hidden;
}
...
.item7 {
  width: 100%;
  height: 2.85rem;
  background: url('../assets/images/spring-market/item_07.jpg') no-repeat center 0;
  background-size: 100% 100%;
  overflow: hidden;
}
...
.item8 {
  width: 100%;
  padding: 0.78rem 0.11rem 0.3rem 0.11rem;
...
.item8 .tab li i {
  ...
  border-style: solid;
  border-color: transparent transparent #f0f2ff transparent;
  display: block;
  position: absolute;
  left: 50%;
  margin-left: -0.2rem;
...
.tabcon1>li>.username span {
  display: block;
}

.tabcon1>li>.username i {
  font-size: 0.24rem;
  line-height: 0.28rem;
  height: 0.28rem;
  color: #7685f4;
...
.tabcon1>li>.book {
  width: 1.6rem;
  height: 0.46rem;
  background: url('../assets/images/spring-market/book.png') no-repeat center 0;
...
.item9 {
  width: 100%;
  height: 2.02rem;
  background: url('../assets/images/spring-market/item_09.jpg') no-repeat center 0;
  background-size: 100% 100%;
  overflow: hidden;
}
...
.ok {
  ...
  width: 5.88rem;
  height: 9.77rem;
  background: url('../assets/images/spring-market/ok.png') center 0 no-repeat;
  background-size: 100% 100%;
  z-index: 7;
  position: fixed;
  top: 10%;
...
.over {
  ...
  width: 6.5rem;
  height: 8.2rem;
  background: url('../assets/images/spring-market/over.png') center 0 no-repeat;
  background-size: 100% 100%;
  z-index: 7;
  position: fixed;
  top: 10%;
...
.ok2 {
  background: url('../assets/images/spring-market/ok2.png') center 0 no-repeat;
  background-size: 100% 100%;
}

.ok3 {
  background: url('../assets/images/spring-market/ok3.png') center 0 no-repeat;
  background-size: 100% 100%;
}
...
export default {
  ...
  methods: {
    ...
    gotoDetail(tipId) {
      window.jrj.jsCallNative('102', JSON.stringify({
        id: tipId
      }))
    }
  },
