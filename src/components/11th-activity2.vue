...
.bg1.bg1-2 {
    background: url("../assets/images/11th-activity2/11th2-bg1-2.jpg") center 0 no-repeat;
    height: 7.09rem;
    background-size: 100% 100%;
    position: relative;
}
.bg1.bg1-3 {
    background: url("../assets/images/11th-activity2/11th2-bg1-3.jpg") center 0 no-repeat;
    height: 7.09rem;
    background-size: 100% 100%;
    position: relative;
}
