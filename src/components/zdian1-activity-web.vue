...
export default {
    ...
    methods: {
        ...
        showLotteryResult() {
            if (this.prize > 0) {
                if (this.prize === 8) {
                    this.pop2Html = '<h3 class="pop-title">遗憾了！<br />大奖与您擦肩而过</h3><p class="fz26 cl1">参与现金券抢购，</p><p class="fz20 cl1">可以获得更多抽奖机会。</p><p class="fz20 cl1">祝您投资愉快</p>'
                } else {
    ...
    mounted() {
        ...
        window.setInterval(function() {
            ShowCountDown(2017, 12, 31, 'divdown1')
        }, 1000)
        $('.nav a').click((e) => {
