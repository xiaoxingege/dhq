...
html,
body {
  font: 20px/1rem 'Microsoft Yahei';
  color: #333;
}
...
.item {
  width: 100%;
  height: 8rem;
  background: url(http://i0.jrjimg.cn/zqt-red-1000/focus/focus20170711vip/h5bg_01.jpg?c) no-repeat center;
...
.item2 {
  background-image: url(http://i0.jrjimg.cn/zqt-red-1000/focus/focus20170711vip/h5bg_02.jpg?b);
  position: relative;
  height: 1.1rem;
...
.item4 {
  background-image: url(http://i0.jrjimg.cn/zqt-red-1000/focus/focus20170711vip/h5bg_04.jpg?1);
  margin-top: -1rem;
}

.item5 {
  background-image: url(http://i0.jrjimg.cn/zqt-red-1000/focus/focus20170711vip/h5bg_05.jpg);
}

.item6 {
  background-image: url(http://i0.jrjimg.cn/zqt-red-1000/focus/focus20170711vip/h5bg_06.jpg?b);
}

.item7 {
  background-image: url(http://i0.jrjimg.cn/zqt-red-1000/focus/focus20170711vip/h5bg_07.jpg?b);
  position: relative;
}

.item8 {
  background-image: url(http://i0.jrjimg.cn/zqt-red-1000/focus/focus20170711vip/h5bg_08.jpg?b);
}

.item9 {
  background-image: url(http://i0.jrjimg.cn/zqt-red-1000/focus/focus20170711vip/h5bg_09.jpg?b);
}

.item10 {
  background-image: url(http://i0.jrjimg.cn/zqt-red-1000/focus/focus20170711vip/h5bg_10.jpg?b);
}

.item11 {
  background-image: url(http://i0.jrjimg.cn/zqt-red-1000/focus/focus20170711vip/h5bg_11.jpg?b);
  height: 6.17rem;
  position: relative;
}

.item12 {
  background-image: url(http://i0.jrjimg.cn/zqt-red-1000/focus/focus20170711vip/h5c.png?b);
  height: 1.2rem;
  position: fixed;
  bottom: 0;
  width: 100%;
...
.item3.item3_type0 {
  background-image: url('../assets/images/vip-h5/item3bg_type0.jpg');
}

.item3.item3_type1 {
  background-image: url('../assets/images/vip-h5/item3bg.jpg');
}
...
#img {
  width: 6.57rem;
  height: 3.32rem;
  background: url(http://i0.jrjimg.cn/zqt-red-1000/focus/focus20170711vip/go0.jpg) no-repeat center center;
  z-index: 3;
  position: relative;
  background-size: 100% 100%;
  margin: -.3rem auto 0;
...
.msgbox {
  ...
  background: url(http://i0.jrjimg.cn/zqt-red-1000/focus/focus20170711vip/h5bt.jpg) no-repeat bottom;
  background-size: 100% auto;
...
.layer {
  ...
  top: 50%;
  left: 50%;
  margin-top: -1.7748rem;
  margin-left: -3.48rem;
  z-index: 21;
  color: #000;
  animation: haha .6s cubic-bezier(1, -0.49, 0, 1.5);
  color: #97d2ee;
  background: url(http://i0.jrjimg.cn/zqt-red-1000/focus/focus20170711vip/layh5.png?ab);
  background-size: 100% 100%;
}
...
.layer_success {
  background-image: url(http://i0.jrjimg.cn/zqt-red-1000/focus/focus20170711vip/layh52.png);
  height: 7.675rem;
  margin-top: -3.837rem;
}
...
.h5b {
  width: 5rem;
  height: 1.54rem;
  background: url(http://i0.jrjimg.cn/zqt-red-1000/focus/focus20170711vip/h5b.png) no-repeat;
  background-size: 100% 100%;
  margin: 0 auto;
}
...
<div class="vip-h5">
  ...
  <div v-if="type===0" class="item item3 item3_type0">
    <div class="item3-contanier">
      ...
      <div class="ai">
        <a href="http://itougu.jrj.com.cn/xlive/web/vipDetailApp.jspa?tgid=140912010047742826" style="margin-left:0.35rem;"></a>
        <a href="http://itougu.jrj.com.cn/xlive/web/vipDetailApp.jspa?tgid=100323010017140421" style="margin-left:1.18rem;"></a>
      </div>
    </div>
  </div>
  ...
  <div v-if="type==='1'" class="item item3 item3_type1">
    <div class="item3-contanier">
      ...
      <div class="ai">
        <a href="http://itougu.jrj.com.cn/xlive/web/vipDetailApp.jspa?tgid=170607010061378568" style="margin-left:2.4rem;"></a>
      </div>
    </div>
  </div>
  ...
  <div class="msgbox">
    ...
    <div v-if="type===0" class="h5b clearfix links1">
      ...
      <a href="http://itougu.jrj.com.cn/xlive/web/vipDetailApp.jspa?tgid=140912010047742826" class="fr h5ba2"></a>
    </div>
