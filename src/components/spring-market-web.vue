...
.part1 {
  width: 100%;
  height: 725px;
  background: url('../assets/images/spring-market/part_01.jpg') center 0 no-repeat;
}

.part2 {
  width: 100%;
  height: 800px;
  background: url('../assets/images/spring-market/part_02.png') center 0 no-repeat;
}

.part3 {
  width: 100%;
  height: 938px;
  background: url('../assets/images/spring-market/part_03.png') center 0 no-repeat;
}
...
.part6 {
  width: 100%;
  background: url('../assets/images/spring-market/bg_12.jpg') center 0 no-repeat;
...
.part4Box>div {
  width: 300px;
  height: 84px;
  background: url('../assets/images/spring-market/part_05.png') center 0 no-repeat;
...
.rec {
  width: 519px;
  height: 109px;
  background: url('../assets/images/spring-market/bookWeb.png') center 0 no-repeat;
  background-size: 100% 100%;
  margin: 0 auto;
}
...
.part7 {
  width: 100%;
  height: 211px;
  background: url('../assets/images/spring-market/bottom_30.jpg') center 0 no-repeat;
}
...
.part5>.part4Box>div {
  width: 300px;
  height: 86px;
  background: url('../assets/images/spring-market/part_13.png') center 0 no-repeat;
  top: -28px;
}
...
.part6>.part4Box>div {
  width: 338px;
  height: 86px;
  background: url('../assets/images/spring-market/part_21.png') center 0 no-repeat;
  margin-left: -169px;
  top: -28px;
}
