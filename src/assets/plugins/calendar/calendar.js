(function(e, t) {
    ...
    if (typeof exports == "object") {
        ...
        var r = "moment";
        return n = e.defined && e.defined(r) ? e(r) : undefined,
        t(n)
...
function(e) {
    ...
    y = function(e, t, n) {
        ...
        for (r in t) {
            i = e[r] !== undefined;
            if (i && typeof t[r] == "object" && t[r].nodeName === undefined) p(t[r]) ? n && (e[r] = new Date(t[r].getTime())) : h(t[r]) ? n && (e[r] = t[r].slice(0)) : e[r] = y({},
            t[r], n);
            else if (n || !i) e[r] = t[r]
        }
        return e
    ...
    E = function(e, t, n, r, i) {
        ...
        var s = [];
        return r && s.push("is-disabled"),
        n && s.push("is-today"),
        t && s.push("is-selected"),
        '<td data-day="' + e + '" class="' + s.join(" ") + '"><button class="pika-button" type="button">' + e + "</button>" + "</td>"
    },
    S = function(e, t) {
    ...
    N = function(e) {
        ...
        l = '<div class="pika-label">' + i.i18n.months[s] + '<select class="pika-select pika-select-month">' + r.join("") + "</select></div>",
        h(i.yearRange) ? (t = i.yearRange[0], n = i.yearRange[1] + 1) : (t = o - i.yearRange, n = 1 + o + i.yearRange);
        for (r = []; t < n && t <= i.maxYear; t++) t >= i.minYear && r.push('<option value="' + t + '"' + (t === o ? " selected": "") + ">" + t + "</option>");
        return c = '<div class="pika-label">' + o + i.yearSuffix + '&nbsp;&nbsp;年<select class="pika-select pika-select-year">' + r.join("") + "</select></div>",
        i.showMonthAfterYear ? f += c + l: f += c + l,
        u && (s === 0 || i.minMonth >= s) && (p = !1),
        a && (s === 11 || i.maxMonth <= s) && (d = !1),
        f += '<button class="pika-prev' + (p ? "": " is-disabled") + '" type="button">' + i.i18n.previousMonth + "</button>",
        f += '<button class="pika-next' + (d ? "": " is-disabled") + '" type="button">' + i.i18n.nextMonth + "</button>",
        f += "</div>"
    },
    C = function(e, t) {
    ...
    k = function(o) {
        ...
        u._onMouseDown = function(e) {
            ...
            if (!f(t, "is-disabled")) {
                if (f(t, "pika-button") && !f(t, "is-empty")) {
                    u.setDate(new Date(u._y, u._m, parseInt(t.innerHTML, 10))),
                    a.bound && i(function() {
                        u.hide()
                    },
                    100);
        ...
        u._onInputChange = function(n) {
            ...
            t ? (r = e(a.field.value, a.format), r = r && r.isValid() ? r.toDate() : null) : r = new Date(Date.parse(a.field.value)),
            u.setDate(p(r) ? r: null),
            u._v || u.show()
        },
        ...
        u._onClick = function(e) {
            ...
            var t = e.target || e.srcElement,
            r = t;
            if (!t) return; ! n && f(t, "pika-select") && (t.onchange || (t.setAttribute("onchange", "return;"), s(t, "change", u._onChange)));
            do
            if (f(r, "pika-single")) return;
            while (r = r.parentNode);
            u._v && t !== a.trigger && u.hide()
        },
        u.el = r.createElement("div"),
        u.el.className = "pika-single" + (a.isRTL ? " is-rtl": ""),
        s(u.el, "mousedown", u._onMouseDown, !0),
        s(u.el, "change", u._onChange),
        a.field && (a.bound ? r.body.appendChild(u.el) : a.field.parentNode.insertBefore(u.el, a.field.nextSibling), s(a.field, "change", u._onInputChange), a.defaultDate || (t && a.field.value ? a.defaultDate = e(a.field.value, a.format).toDate() : a.defaultDate = new Date(Date.parse(a.field.value)), a.setDefaultDate = !0));
        var l = a.defaultDate;
        p(l) ? a.setDefaultDate ? u.setDate(l, !0) : u.gotoDate(l) : u.gotoDate(new Date),
        a.bound ? (this.hide(), u.el.className += " is-bound", s(a.trigger, "click", u._onInputClick), s(a.trigger, "focus", u._onInputFocus), s(a.trigger, "blur", u._onInputBlur)) : this.show()
    };
    return k.prototype = {
        config: function(e) {
            this._o || (this._o = y({},
            ...
            t.bound = !!(t.bound !== undefined ? t.field && t.bound: t.field),
            ...
            t.minDate && (m(t.minDate), t.minYear = t.minDate.getFullYear(), t.minMonth = t.minDate.getMonth()),
            t.maxDate && (m(t.maxDate), t.maxYear = t.maxDate.getFullYear(), t.maxMonth = t.maxDate.getMonth());
            if (h(t.yearRange)) {
                var r = (new Date).getFullYear() - 10;
                t.yearRange[0] = parseInt(t.yearRange[0], 10) || r,
                t.yearRange[1] = parseInt(t.yearRange[1], 10) || r
            } else t.yearRange = Math.abs(parseInt(t.yearRange, 10)) || b.yearRange,
        ...
        toString: function(e) {
            ...
            return r = r < 10 ? "0" + r: r,
            i = i < 10 ? "0" + i: i,
            p(this._d) ? t ? window.moment(this._d).format(e || this._o.format) : n + "-" + r + "-" + i: ""
        },
        getMoment: function() {
        ...
        setDate: function(e, t) {
            ...
            r = this._o.maxDate;
            p(n) && e < n ? e = n: p(r) && e > r && (e = r),
            this._d = new Date(e.getTime()),
            m(this._d),
            this.gotoDate(this._d),
            this._o.field && (this._o.field.value = this.toString(), u(this._o.field, "change", {
                firedBy: this
            })),
        ...
        draw: function(e) {
            ...
            s = t.minMonth,
            o = t.maxMonth;
            this._y <= n && (this._y = n, !isNaN(s) && this._m < s && (this._m = s)),
            this._y >= r && (this._y = r, !isNaN(o) && this._m > o && (this._m = o)),
            this.el.innerHTML = N(this) + this.render(this._y, this._m),
            t.bound && (this.adjustPosition(), t.field.type !== "hidden" && i(function() {
                t.trigger.focus()
            },
            1));
        ...
        adjustPosition: function() {
            ...
            a, f, l;
            if (typeof e.getBoundingClientRect == "function") l = e.getBoundingClientRect(),
            a = l.left + window.pageXOffset,
            f = l.bottom + window.pageYOffset;
            else {
                a = t.offsetLeft,
                f = t.offsetTop + t.offsetHeight;
                while (t = t.offsetParent) a += t.offsetLeft,
                f += t.offsetTop
            }
        ...
        render: function(e, t) {
            ...
            u = [];
            m(r),
            n.firstDay > 0 && (s -= n.firstDay, s < 0 && (s += 7));
            var a = i + s,
            f = a;
            while (f > 7) f -= 7;
            a += 7 - f;
            ...
            c = 0; l < a; l++) {
                ...
                b = g(h, r),
                w = l < s || l >= i + s;
                u.push(E(1 + (l - s), y, b, d, w)),
                ++c === 7 && (o.push(S(u, n.isRTL)), u = [], c = 0)
            }
            return C(n, o)
        },
        isVisible: function() {
        ...
        destroy: function() {
            ...
            this._o.field && (o(this._o.field, "change", this._onInputChange), this._o.bound && (o(this._o.trigger, "click", this._onInputClick), o(this._o.trigger, "focus", this._onInputFocus), o(this._o.trigger, "blur", this._onInputBlur))),
