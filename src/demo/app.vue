<style>
    ...
    body, button, input, select, textarea { font-family: 'PingFang SC'，'Droid Sans Fallback',"Microsoft YaHei","微软雅黑",simsun,"宋体",tahoma,arial; }
    ...
    body {
        ...
        font-family:'PingFang SC'，'Droid Sans Fallback',"Microsoft YaHei","微软雅黑",tahoma,Helvetica,arial,sans-serif,simsun,"宋体";
    }
    ...
    * html .clearfix { height: 1%; }
    ...
    .fadein-item-transition { opacity:1;-moz-transition:all .5s; -o-transition:all .5s; -webkit-transition:all .5s; transition:all .5s; }
    .fadein-item-enter,.fadein-item-leave { opacity:0;  }

    .empty { font-size: .42rem;padding: .75rem;}
    .empty > div { height: 5rem;background: #fff; display: -webkit-box;display: -ms-flexbox;color: #999;
                    display: -webkit-flex;
                    display: flex;
